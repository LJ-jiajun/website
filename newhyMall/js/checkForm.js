 ...
 * 常用的正则表达式:
	...
	中文字符的正则表达式：[\u4e00-\u9fa5]
 	...
 	//匹配生日的年月日（1900-2018），中间可以用./-_连接，进行了大小月判断，未进行闰年判断，设定2月有29天，如有必要请另行判断
	var zz = /(^19[0-9]{2})|(^200[0-9]|201[0-8])[\.\/_\-]((((0?[13578])|(1[02]))[\.\/_\-]((0?[1-9])|([12][0-9])|(3[01]))$)|(((0?[469])|(11))[\.\/_\-]((0?[1-9])|([12][0-9])|(30))$)|(0?2[\.\/_\-]((0?[1-9])|([12][0-9]))$))/;
	//匹配生日的年份
	var zzz1 = /(^19[0-9]{2})|(^200[0-9]|201[0-8])[\.\/_\-]/;
	//匹配生日的月份和日期
	var zzz2 = /((((0?[13578])|(1[02]))[\.\/_\-]((0?[1-9])|([12][0-9])|(3[01]))$)|(((0?[469])|(11))[\.\/_\-]((0?[1-9])|([12][0-9])|(30))$)|(0?2[\.\/_\-]((0?[1-9])|([12][0-9]))$))/;
 */
